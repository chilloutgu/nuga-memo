...
public class MemoController {
    ...
    public Mono<String> createMemo(@RequestBody Mono<MemoCdo> memoCdoMono) {
        return memoCdoMono.flatMap(memoService::createMemo);
    }
